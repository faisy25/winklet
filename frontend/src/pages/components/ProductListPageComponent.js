...
import ProductForListComponent from "../../componenets/ProductForListComponent";
import SortOptionsComponent from "../../componenets/SortOptionsComponent";
import PriceFilterComponent from "../../componenets/filterQueryResultOptions/PriceFilterComponent";
import RatingFilterComponent from "../../componenets/filterQueryResultOptions/RatingFilterComponent";
import CategoryFilterComponent from "../../componenets/filterQueryResultOptions/CategoryFilterComponent";
import AttributesFilterComponent from "../../componenets/filterQueryResultOptions/AttributesFilterComponent";
...
const ProductListPageComponent = ({ getProducts, categories }) => {
  ...
  const [attrsFilter, setAttrsFilter] = useState([]); //collect attributes from db and show on the webpage
  const [attrsFromFilter, setAttrsFromFilter] = useState([]); // collect user flter for category attributes

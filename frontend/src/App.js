...
import ProtectedRoutesComponent from "./componenets/ProtectedRoutesComponent";
...
import RoutesWithUserChatComponenet from "./componenets/user/RoutesWithUserChatComponet";
  ...
  return (
    <>
      <BrowserRouter>
        ...
        <HeaderComponent />
        <Routes>
          <Route element={<RoutesWithUserChatComponenet />}>
